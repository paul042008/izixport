...
// ─── Field component moved OUTSIDE AddListing to prevent remounting ─────────
...
export default function AddListing() {
  ...
  const [form, setForm] = useState({
    ...
    price_per_unit: '', unit: '', min_order_quantity: '',
    available_quantity: '', origin_state: '', quality_grade: '',
    shipping_terms: '',
  })
    ...
    <div className="mk-root" style={{ paddingBottom: 'calc(96px + env(safe-area-inset-bottom,0px))' }}>
      <style>{`
        ...
        .al-progress > span {
          display: block;
          height: 100%;
          background: linear-gradient(90deg, #0C3825, #1A5C41);
          border-radius: 999px;
        }
      ...
      <header className="mk-header">
        <div className="mk-header-inner">
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <button
              onClick={() => navigate('/dashboard/exporter?tab=listings')}
              className="mk-btn mk-btn-ghost mk-btn-sm"
              style={{ padding: 8, minHeight: 36, width: 36 }}
              aria-label="Back"
            >
              <ChevronLeft size={18} />
            </button>
            <div className="mk-logo-frame">
              <img src="/logo.jpeg" alt="IziXport" />
            </div>
          </div>
      ...
      <div className="mk-container-narrow mk-fade-up" style={{ maxWidth: 1240 }}>
        <div style={{
          ...
          marginBottom: 18,
          position: 'relative',
          boxShadow: '0 12px 30px rgba(12,56,37,0.18)',
        }}>
              ...
              <div className="al-section-body">
                <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                  ...
                  <Field label="Product title *" error={errors.title}>
                    <input
                      className={`mk-field ${errors.title ? 'is-error' : ''}`}
                      placeholder="e.g. Premium Grade-A Sesame Seeds"
                      value={form.title}
                  ...
                  <Field label="Description (optional)">
                    <textarea
                      className="mk-field"
                      rows={4}
                      placeholder="Describe your product quality, source, packaging, certifications…"
            ...
            <div className="al-section">
              ...
              <div className="al-section-body">
                <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10, marginTop: 4 }}>
                    {images.map((file, idx) => (
                      <div key={idx} style={{ position: 'relative', aspectRatio: '1', borderRadius: 12, overflow: 'hidden', background: '#f1f5f9', border: '1px solid var(--mk-border)' }}>
                        ...
                        <button
                          ...
                          style={{ position: 'absolute', top: 6, right: 6, width: 22, height: 22, borderRadius: 999, background: 'rgba(15,23,42,.7)', border: 'none', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}
                        >
                          <X size={11} />
                        </button>
                      </div>
                    ...
                    {images.length < 4 && (
                      <button
                        ...
                        style={{ aspectRatio: '1', borderRadius: 12, border: '1.5px dashed #cbd5e1', background: 'var(--mk-surface-alt)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 4, color: 'var(--mk-text-3)', cursor: 'pointer', fontFamily: 'var(--mk-font-heading)', fontSize: 11, fontWeight: 600 }}
                      >
                        <Upload size={18} />
                        Add photo
                      </button>
                  ...
                  <p className="mk-text-muted" style={{ fontSize: 12, marginTop: 8 }}>
                    First image is the cover. JPEG or PNG, max 5MB each.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="al-sidebar">
            <div className="al-preview">
              <div className="al-preview-hero">
                <p style={{ fontSize: 10, letterSpacing: '.16em', textTransform: 'uppercase', fontWeight: 700, color: 'rgba(255,255,255,.55)', margin: '0 0 10px' }}>
                  Live preview
                </p>
                <div style={{ position: 'relative', zIndex: 1 }}>
                  ...
                  <div style={{ fontFamily: 'var(--mk-font-heading)', fontWeight: 800, fontSize: 22, lineHeight: 1.05, marginBottom: 8 }}>
                    {liveTitle}
                  </div>
              ...
              <div className="al-preview-body">
                ...
                <div style={{ padding: 14, borderRadius: 12, background: 'rgba(26,92,65,.06)', border: '1px solid rgba(26,92,65,.14)' }}>
                  <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: '.12em', textTransform: 'uppercase', color: '#9B7A2A', margin: '0 0 6px' }}>
                    Quick tip
                  </p>
                  <p style={{ fontSize: 12.5, lineHeight: 1.65, color: '#44403C', margin: 0 }}>
                    Strong photos and a simple description usually improve buyer trust and response time.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="al-preview" style={{ padding: 18 }}>
              <p style={{ fontSize: 10, letterSpacing: '.16em', textTransform: 'uppercase', fontWeight: 700, color: '#9B7A2A', margin: '0 0 10px' }}>
